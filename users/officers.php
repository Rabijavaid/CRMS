...
<form id="searchForm">
	...
	<!--     search filters   !-->
			<div id="filter">
				<input class="filterValue" type="radio" id="r1" name="filter" checked="checked" value="name" /><label for="r1"  >NAME</label>
				<input class="filterValue" type="radio" id="r2" name="filter" value="rank" /><label for="r2">RANK</label>
				<input class="filterValue" type="radio" id="r3" name="filter" value="ps_id" /><label for="r3">POLICE STATION</label>
				<input class="filterValue" type="radio" id="r4" name="filter" value="cases" /><label for="r4">CASES</label>
			</div>
